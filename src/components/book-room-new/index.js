...
class BookRoom extends React.Component {
  ...
  handleSubmit = (e) => {
    ...
    this.state.visitors.forEach((visitor, index) => {
      ...
      formData.append(`visitors[${index}][relation]`, visitor.relation);
      formData.append(`visitors[${index}][country_code]`, visitor.countryCode);
      formData.append(`visitors[${index}][mobile]`, visitor.mobile);
    ...
    return (
      <div className={tailwindWrapper("w-2/3")}>
        <form
          ...
          className={tailwindWrapper("px-8 pt-6 pb-8 mb-4")}
        >
          <div className={tailwindWrapper("mb-4 w-full flex gap-3")}>
            <div>
              ...
              <input
                ...
                className={tailwindWrapper(
                  "border rounded  py-4 px-10 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                )}
              />
            </div>
                ...
                <div className={tailwindWrapper("flex gap-4 mt-4")}>
                  <div className={tailwindWrapper("flex flex-col")}>
                    ...
                    <input
                      ...
                      placeholder="Mr"
                      className={tailwindWrapper(
                        "appearance-none border rounded py-4 text-center w-[70px] text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                      )}
                    />
                  </div>
                  <div className={tailwindWrapper("flex flex-col")}>
                    ...
                    <input
                      ...
                      className={tailwindWrapper(
                        "appearance-none border rounded py-4 px-6 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                      )}
                    />
                  </div>
                  <div className={tailwindWrapper("flex flex-col")}>
                ...
                <div className={tailwindWrapper("flex gap-4 mt-4")}>
                  ...
                  <div className={tailwindWrapper("flex flex-col")}>
                    ...
                    <input
                      ...
                      className={tailwindWrapper(
                        "appearance-none border rounded py-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                      )}
                    />
                  </div>
                </div>
                <div className={tailwindWrapper("flex mt-4 gap-4")}>
                  <div className={tailwindWrapper("mr-2")}>
                    ...
                    <input
                      ...
                      className={tailwindWrapper(
                        "appearance-none border rounded py-4 px-6 text-gray-700 leading-tight focus:outline-none focus:shadow-outline w-full"
                      )}
                    />
                  </div>
                  <div className={tailwindWrapper("")}>
          ...
          <div className={tailwindWrapper("my-8")}>
            <button
              ...
              className={tailwindWrapper("text-[#0B2274] text-xl font-bold")}
            >
              + Add Visitor
            </button>
          </div>
          <button
            ...
            disabled={loading}
            className={tailwindWrapper(
              "bg-[#0B2274]  text-white font-bold py-2 px-16 rounded focus:outline-none focus:shadow-outline"
            )}
          >
