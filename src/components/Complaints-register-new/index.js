      ...
      <div className={tailwindWrapper("w-full")}>
        {this.state.error && (
          ...
          >
            ...
            <span className={tailwindWrapper("block sm:inline")}>
              {this.state.message}
            </span>
          </div>
        )}
        ...
        <h3
          className={tailwindWrapper("text-xl text-[#133BC5] font-bold mt-4")}
        >
          My Complaints
        </h3>
            ...
            >
              ...
              >
                <tr className={tailwindWrapper("")}>
                  <th
                    scope="col"
                    className={tailwindWrapper(
                      "px-6 py-6 text-left text-xs font-medium text-white uppercase tracking-wider"
                    )}
                  >
                    ID
                  </th>
              ...
              >
                {complaints.map((complaint, index) => (
                  ...
                  >
                    <td
                      className={tailwindWrapper("px-6 py-4 whitespace-nowrap")}
                    >
                      {index + 1}
                    </td>
                    <td
