        ...
        <table className={tailwindWrapper("")}>
          <thead className={tailwindWrapper("p-12 bg-[#6381EB] text-white")}>
            <tr className={tailwindWrapper("grid grid-cols-5 px-6 py-4")}>
              <td className={tailwindWrapper("px-4 py-2 col-span-2 ")}>
                Feedbacks
              </td>
          ...
          <tbody>
            {/* TODO: real data will be done after feedback actions */}
            <tr className={tailwindWrapper("grid grid-cols-5")}>
              <td className={tailwindWrapper("border px-4 py-2 col-span-2")}>
                Some feedback text
              </td>
              <td className={tailwindWrapper("border px-4 py-2")}>
                Attachment
              </td>
